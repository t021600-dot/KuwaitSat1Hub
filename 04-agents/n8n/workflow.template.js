...
var TAIL_DELIVER = [
  ...
  "/* prep.refusal_notice is null on every clean run. When the objective",
  "   carried an instruction it is the sentence naming what was refused,",
  "   and it leads the draft a human approves (capstone COULD 14). */",
