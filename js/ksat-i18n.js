...
(function () {
  ...
  var ARABIC = {
    ...
    'mis.spec':  'سجل المهمة',
    'mis.specn':  'أربع عشرة مدخلة منشورة، ولكل منها مصدرها',
    ...
    'ft.src':    'المصادر',
    'ft.leg':    'الحالة',
    'ft.l1':     'صور كويت سات-١ مستخدَمة بإذن من فريق كويت سات-١ في جامعة الكويت.',
    /* THE FORMAL NOTICE at the foot of the public page. The permission
       the team holds is for the IMAGERY; the second paragraph is
       everything that permission is not, and it has to travel with the
       first in both languages. */
    'ft.dis.h':  'إخلاء مسؤولية',
    'ft.dis.p1': 'صور الحمولة من كويت سات-١ المعروضة في هذه المنصة تُستخدم بإذن من فريق كويت سات-١ في جامعة الكويت. ويقتصر هذا الإذن على استخدام الصور دون سواه.',
    'ft.dis.p2': 'هذه المنصة مشروع أكاديمي مستقل. وهي غير معتمدة من جامعة الكويت أو مؤسسة الكويت للتقدم العلمي أو مشروع كويت سات-١، ولا تحمل أي تكليف منها. وجميع ما ورد فيها من تحليل وترتيب وتوصية هو من عمل مؤلفيها، ولا يشكّل أي جزء منها أداة تخطيط رسمية.',
