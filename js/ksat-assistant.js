  ...
  var KB = [
    ...
    },
    {
      ...
      rows: [
        ...
        { id: 'analysis', prov: 'platform',
          en: 'Sign in, open the research console, state what you are trying to find out, choose the area and the period, and press Run Research.\nYou will see each agent report as it goes, including the zones it refuses and why.',
          ar: 'سجّل الدخول، وافتح وحدة البحث، وحدّد ما تحاول معرفته، واختر المنطقة والفترة، ثم اضغط تشغيل البحث.\nسترى تقرير كل وكيل أولاً بأول، بما في ذلك المناطق التي يرفضها وسبب الرفض.' },
        { id: 'result', prov: 'platform',
