...
/* ------------------------------------------------------------------ */
const LAYER_LINE = /ksat-(integration|theme|shell|workflow|assistant|density|i18n|agency)\.(css|js)|Plex\+Sans\+Arabic|vendor\/supabase\.js|js\/config\.js|^\s*<!--\s*=====\s*integration layer|^\s*(Added by 03 Security|this comment was changed|is kept at site-original)/;
